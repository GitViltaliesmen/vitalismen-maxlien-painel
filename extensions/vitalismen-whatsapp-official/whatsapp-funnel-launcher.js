(() => {
    ...
    const makeLauncher = () => {
        ...
        const needsBuild = !host.shadowRoot || !host.shadowRoot.querySelector('[data-toolbar-version="0.13.5"]');
        if (needsBuild) {
            const root = host.shadowRoot || host.attachShadow({ mode: 'open' });
            root.innerHTML = `
                <style>
                ...
                <div class="toolbar" data-toolbar-version="0.13.5">
