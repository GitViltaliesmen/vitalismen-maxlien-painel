(function (root) {
    ...
    root.VitalismenProductFunnel.register({
        ...
        templates: [
            ...
            { id: 'tex_ultra_ec:offer', code: 'P02', category: 'oferta', stages: ['qualificando', 'oferta'], title: 'Oferta por quantidade', preview: 'Apresenta as opções sem pressionar', text: ['📦 *Hoy tenemos kits promocionales disponibles con precios especiales*:', '🟢 1 frasco por solo $35,99', '🟡 2 frascos por $70,00', '🟠 3 frascos por $80,99', '🔴 6 frascos (tratamiento completo) por $147,99', '', '¿Cuántos frascos desea?'].join('\n') },
