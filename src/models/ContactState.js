...
const contactStateSchema = new mongoose.Schema({
    ...
    engagementAutomation: {
        ...
        passiveInboundCount: { type: Number, min: 0, default: 0 },
        passiveReplyTarget: { type: Number, enum: [2, 3], default: 2 },
        passiveReplyCycle: { type: Number, min: 0, default: 0 },
        passiveLastCountedMessageId: { type: String, default: '' },
