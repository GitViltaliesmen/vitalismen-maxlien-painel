...
// Entrada canônica: V74 sucede apenas o FREEZE_LOCK_EC e termina validando V73 → V72 → runtime V71.
// A semântica operacional permanece V71 STRICT_READ_ONLY; V72 não cria runtime-chain-v72.
// Cadeia herdada: V74 → V73 → V72 → V71 → V70 → V69 → V68 → runtimeGuardChainFreezeRuntimeGuardV67.js → V66 e ancestrais.
