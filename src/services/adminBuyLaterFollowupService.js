...
const buildBuyLaterText = (lead = {}) => {
    ...
    return `Hola ${name}, soy Ana López de Vit Power. Quedamos en escribirle${targetText}. Si todavia desea continuar con su pedido, me responde por aqui y le ayudo a retomarlo.`;
};
