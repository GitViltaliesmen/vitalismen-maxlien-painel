export const POST_SALE_TEMPLATE_CATALOG_V147 = Object.freeze({
    ...
    BONUS_ACCESS_TEMPLATE: Object.freeze({ id: 'P6_BONUS_ACCESS', labels: Object.freeze(['VIT_POWER_PICKUP_BONUS_TEXT']), enabled: true, country: 'EC', product: 'all', trigger: 'delivery_or_pickup_plus_canonical_payment_after_p5', textPresent: true, mediaPresent: false, placeholdersValid: true }),
    USAGE_TEX_ULTRA: Object.freeze({ id: 'P7_USAGE_TEX_ULTRA', labels: Object.freeze(['MODO_DE_USO_TEX_ULTRA']), enabled: true, country: 'EC', product: 'tex_ultra_ec', trigger: 'p6_provider_accepted_plus_canonical_payment', textPresent: false, mediaPresent: true, placeholdersValid: true }),
    USAGE_VIT_POWER: Object.freeze({ id: 'P7_USAGE_VIT_POWER', labels: Object.freeze(['COMO_SE_TOMA_VIT_POWER']), enabled: true, country: 'EC', product: 'vit_power_ec', trigger: 'p6_provider_accepted_plus_canonical_payment', textPresent: false, mediaPresent: true, placeholdersValid: true }),
    USAGE_NITRIX: Object.freeze({ id: 'P7_USAGE_NITRIX', labels: Object.freeze(['NITRIX_USO_OXIDE_EC']), enabled: true, country: 'EC', product: 'nitrix_ec', trigger: 'p6_provider_accepted_plus_canonical_payment', textPresent: false, mediaPresent: true, placeholdersValid: true })
});
