export const evaluateTrafficReadinessV171 = ({
    ...
    if (safety.strictReadOnly !== false || safety.botCoreOperational !== true || safety.coreMutationRoutesEnabled !== true) reasons.push('bot_core_routes_not_enabled');
    if (safety.operationalMutationsEnabled !== false || safety.mutatingRoutesEnabled !== false) reasons.push('global_mutation_surface_enabled');
