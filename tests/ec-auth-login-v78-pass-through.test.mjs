...
test('auth, middleware, painel e rate limiter permanecem byte a byte na baseline V125', () => {
    ...
    assert.equal(sha256('public/qr.html'), 'cf96628dffbd8c75746f9d318df0c499afb60ceec715cf60b28e904544585bd6');
