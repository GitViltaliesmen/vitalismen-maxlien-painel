...
test('V30 sucede exatamente V29.2 e mantém ativação bloqueada', () => {
    ...
    assert.equal(manifest.publicationStatus, 'local_candidate_not_published');
    assert.equal(manifest.operatorActivationApproval.status, 'required_explicit_after_report');
