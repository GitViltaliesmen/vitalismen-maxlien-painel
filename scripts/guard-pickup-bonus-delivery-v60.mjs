...
assert.match(entryGuard, /(?:pickupBonusDeliveryFreezeRuntimeGuardV60|metaAttributionFreezeRuntimeGuardV61|protocoloGConversionFreezeRuntimeGuardV62|protocoloGAdMetricsFreezeRuntimeGuardV63)\.js/);
