...
for (const phone of phones) {
    ...
    plan.push({
        ...
        assignedSession,
        handoffText: `Señor, le escribe Ana por este numero final ${suffix}. El otro numero esta temporalmente fuera de servicio, pero ya tengo su historial aqui y seguimos sin repetir todo.`,
