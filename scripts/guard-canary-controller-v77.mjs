...
assert.equal(
    ...
    'node src/services/canaryControllerSafetyFreezeRuntimeGuardV77.js && node scripts/guard-canary-controller-v77.mjs && node --test tests/canary-controller-v77.test.mjs'
);
