...
assert.match(entryGuard, /(?:baileysLibsignalSecurityFreezeRuntimeGuardV59|pickupBonusDeliveryFreezeRuntimeGuardV60|metaAttributionFreezeRuntimeGuardV61|protocoloGConversionFreezeRuntimeGuardV62)\.js/);
