...
assert.equal(
    ...
    'node src/services/canaryControllerSafetyFreezeRuntimeGuardV77.js && node scripts/guard-meta-partner-destination-registry-v73.mjs && node --test tests/meta-partner-destination-registry-v73.test.mjs'
);
