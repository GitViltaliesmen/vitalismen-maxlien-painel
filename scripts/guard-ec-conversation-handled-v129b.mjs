...
export const assertConversationHandledV129B = () => {
    ...
    assert.deepEqual(manifest.overrides, ['public/qr.html', 'scripts/lib/ec-runtime-successor-v97-context.mjs', 'src/routes/whatsapp.js', 'src/services/ecPanelCustomerPersistenceV122Service.js', 'src/services/panelReadStateService.js']);
